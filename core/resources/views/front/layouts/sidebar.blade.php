<div id="sidebar" class="sidebar">
    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <!-- begin sidebar nav -->
        <ul class="nav">
            <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> <span>GamePlay</span></a></li>
        ...
        <li><a href="{{route('deposit')}}"><i class="fa fa-credit-card" aria-hidden="true"></i> <span>Deposit</span></a></li>
                  <li><a href="{{route('sell.coin')}}"><i class="fa fa-money" aria-hidden="true"></i> <span>Withdraw</span></a></li>
